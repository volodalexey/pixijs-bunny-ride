...
import { logInputDirection, logKeydown, logKeyup, logPointerEvent } from "../utils/logger";
...
export class InputHandler {
  ...
  addEventLesteners(): void {
    this.eventTarget.eventMode = "static";
  ...
  private applyLeftDirection(pressed: boolean): void {
    this.pointerXDown = pressed ? -1 : this.pointerXDown === -1 ? null : this.pointerXDown;
